...
@section('admin_content')
    <div class="content-wrapper">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        ...
                        <ol class="breadcrumb float-sm-right">
                            <button class="btn btn-primary" data-toggle="modal" data-target="#NewSubCategoryModal">+ Add
                                New</button>
                        </ol>
                    </div>
                </div>
        ...
        <div class="modal fade" id="NewSubCategoryModal" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
